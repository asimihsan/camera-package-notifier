...
export class TrainingStack extends cdk.Stack {
  constructor(scope: cdk.App, id: string, props?: cdk.StackProps) {
    ...
    userData.addCommands(
      ...
      'sudo yum install -y zstd zsh curl util-linux-user tmux htop',
      ...
      `aws s3 cp s3://${dataBucket.bucketName}/data_set.pickle.zst /home/ec2-user/`,
    );

    const p3SpotPrice = "0.5";
    const p4SpotPrice = "1.0";
